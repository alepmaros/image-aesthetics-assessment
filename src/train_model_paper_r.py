...
from models.models import get_model_paper, LossHistory
...
filepath = os.path.join(_BASE_PATH, 'trained_models', 'model_paper_r.h5')
...
model.save(os.path.join(_BASE_PATH, 'trained_models', 'model_paper_r.h5'))
