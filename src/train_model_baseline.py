...
filepath = os.path.join(_BASE_PATH, 'trained_models', 'baseline_model_{epoch:02d}_{val_loss:.2f}.h5')
...
train_generator = DataGeneratorSingleColumn(imgs_train)
valid_generator = DataGeneratorSingleColumn(imgs_cv)
